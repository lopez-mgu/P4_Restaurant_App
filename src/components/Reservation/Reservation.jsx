...
const Reservation = () => {
    ...
    const handleDateChange = (ev) => {
        ...
        /* console.log('handle entro')
        console.log(localStorage.getItem('CocktailAvedate_choose'), localStorage.getItem('CocktailAvetime_choose'),
        localStorage.getItem('CocktailAvemail_choose'), localStorage.getItem('CocktailAvename_choose'),
        localStorage.getItem('CocktailAvepeople_choose'), localStorage.getItem('CocktailAvetel_choose')) */
